  ...
  public static function init($items)
  {
    if (!empty($items)) {
      ...
      foreach ($items AS $item) {
        Menu::$menus['modules'][$item->module]['write'] = '<a href="index.php?module=event-write&amp;mid='.$item->id.'"><span>{LNG_Add New} {LNG_Event}</span></a>';
        Menu::$menus['modules'][$item->module]['setup'] = '<a href="index.php?module=event-setup&amp;mid='.$item->id.'"><span>{LNG_List of} {LNG_Event}</span></a>';
      }
    }
  }
}