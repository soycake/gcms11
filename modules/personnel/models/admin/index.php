<?php
/*
 * @filesource personnel/models/admin/index.php
 * @link http://www.kotchasan.com/
 * @copyright 2016 Goragod.com
 * @license http://www.kotchasan.com/license/
 */

namespace Personnel\Admin\Index;
...
class Model extends \Kotchasan\Model
{
  ...
  public static function module($module_id)
  {
    ...
    if (empty($index)) {
      ...
      // ค่าติดตั้งเริ่มต้น
      $config = ArrayTool::unserialize($index[0]['config'], \Personnel\Admin\Settings\Model::defaultSettings());
